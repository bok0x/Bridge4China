export const SITE_NAME = "Bridge4China";
export const SITE_TAGLINE = "Your bridge to studying in China";
export const SITE_DESCRIPTION =
  "Discover and apply to top Chinese universities. Find scholarships, check tuition costs, and get step-by-step application guidance.";
